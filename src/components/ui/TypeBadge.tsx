...
import { cn } from '@/lib/utils'; // Asegúrate de tener cn util
...
export default function TypeBadge({ type, className, showLabel = true }: TypeBadgeProps) {
  ...
  return (
    <div
      ...
      title={`TYPE: ${type.toUpperCase()}`} // Tooltip Nativo
    >
