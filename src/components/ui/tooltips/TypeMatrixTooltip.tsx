...
import TypeBadge from '../TypeBadge'; // Reutilizamos tu componente existente
...
// Datos simplificados de la matriz (Atacante vs Defensor)
// 0: Neutro, 1: Super Eficaz, 2: Poco Eficaz, 3: Inmune
// ESTO ES UN EJEMPLO REDUCIDO, se necesita la matriz completa 18x18 real.
const MATRIX_MOCK = {
...
const getMultiplier = (attacker: string, defender: string) => {
  ...
  return { text: '', color: '' }; // Neutro
};

export default function TypeMatrixTooltip() {
  return (
    <div className="relative group inline-block">
      {/* Trigger Element (Lo que el usuario ve en el flujo) */}
